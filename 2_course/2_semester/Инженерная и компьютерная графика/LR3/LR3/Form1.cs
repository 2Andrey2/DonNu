...
namespace LR3
{
    public partial class Form1 : Form
    {
        ...
        void star(double xc, double yc, double r)
        {
            ...
            for (i = 0; i < 5; i++)
            {
                phi = (36 + i * ran.Next(0,100)) * factor;

                star(xc + r_double * Math.Cos(phi), yc + r_double * Math.Sin(phi), r_half);

            }
        }
        private void записатьВФайлScratchToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            dc = pictureBox1.CreateGraphics(); p = new Pen(Brushes.Azure, 2);
