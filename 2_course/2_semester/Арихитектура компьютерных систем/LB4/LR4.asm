...
svX db 10,13,'Введи элемент массива X!',10,13,'$'
svXXX db 10,13,'Массив X:',10,13,'$'
ssum db 'Сумма четных элементов c четными номерами строк = $'
...
; Сумма элементов c четными номерами столбцов в нечетных строках= 
test k1,00000001b ; проверяем строку на четность
jnz @dalhe
; нечетная строка
test ax,000000001b ; проверяем элемент на четность
jnz @dalhe
